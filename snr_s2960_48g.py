...
class SNR_S2960_48G(Switch):
    ...
    def config_switch(self):
        ...
        #-----------------------------------------------
        time.sleep(1)
        #Настройка всех eth портов кроме 48 на абонентский доступ
        tn.write(b'interface ethernet0/0/1-48\n')
        time.sleep(1)
        ...
        numb_eth_port=1
        while i<=47:
            tn.write(b'interface ethernet0/0/'+str(numb_eth_port).encode('ascii')+b'\n')         
        ...
        tn.write(b'interface ethernet0/0/49-52\n')
        time.sleep(1)
        ...
        tn.write(b'exit\n')
        time.sleep(1)
        tn.write(b'interface ethernet0/0/52\n')
        time.sleep(1)
