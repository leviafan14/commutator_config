...
class ORION_A26(Switch):
    ...
    def config_switch(self):
        ...
        #------------------------------------
        #Настройка sntp, snmp, loopback-detection глобально
        time.sleep(2)
        ...
        #-----------------------------------------------
        time.sleep(1)
        #Настройка всех eth портов абонентский доступ
        tn.write(b'interface ethernet1/1-24\n')
        ...
        time.sleep(1)
        while i<=23:
            tn.write(b'interface ethernet1/'+str(numb_eth_port).encode('ascii')+b'\n')         
        ...
        tn.write(b'interface ethernet1/25-26\n')
        time.sleep(1)
